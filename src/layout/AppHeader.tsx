...
const AppHeader: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 flex w-full bg-white border-gray-200 z-50 pwa:max-lg:pt-[env(safe-area-inset-top)] dark:border-gray-800 dark:bg-gray-900 lg:border-b">
