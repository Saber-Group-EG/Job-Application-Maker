...
export default function MyPromoRedemptions() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0F172A] p-4 sm:p-8 text-slate-900 dark:text-slate-100">
      <PageMeta
        title={t('myRedemptionsTitle', 'promos')}
        description={t('myRedemptionsSubtitle', 'promos')}
      />
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-4 w-full lg:w-auto bg-white/40 dark:bg-white/5 backdrop-blur-xl border border-white/20 dark:border-white/10 p-4 rounded-[2rem] shadow-sm">
            ...
            <select
              ...
              className="w-full sm:w-auto bg-white dark:bg-black/20 border border-white/20 dark:border-white/5 rounded-xl px-4 py-2 text-sm font-bold outline-none focus:ring-2 focus:ring-brand-500/20 transition-all cursor-pointer"
            >
              <option value="all">
        ...
        {!isLoading && !isError && totalPages > 1 && (
          <nav
            ...
            aria-label={t('myRedemptionsTitle', 'promos')}
          >
            <button
              type="button"
              disabled={page === 1}
