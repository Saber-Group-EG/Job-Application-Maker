...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    if (path.startsWith('/services')) setActiveLink('services');
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 pwa:max-lg:pt-[env(safe-area-inset-top)] transition-all duration-500 ${
        isScrolled
        ...
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <div className="relative">
              <img src="/images/logo/auth-logo.png" alt="Logo" className="h-10 w-auto" />
            </div>
          </Link>
