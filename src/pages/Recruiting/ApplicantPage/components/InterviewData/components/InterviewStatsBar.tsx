...
export const InterviewStatsBar = ({
  ...
  <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-slate-100">
    ...
    <div className="bg-white p-4 text-center">
      ...
      <p className="text-xs text-slate-500 font-medium">{t('achieved', 'interview')}</p>
    ...
    <div className="bg-white p-4 text-center">
      ...
      <p className="text-xs text-slate-500 font-medium">{t('duration', 'interview')}</p>
    ...
    <div className="bg-white p-4 text-center">
      ...
      <p className="text-xs text-slate-500 font-medium">{t('completion', 'interview')}</p>
