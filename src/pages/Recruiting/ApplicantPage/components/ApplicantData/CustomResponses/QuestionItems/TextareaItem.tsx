...
export const TextareaItem: React.FC<{
  ...
  <div className="mb-4 last:mb-0">
    ...
    <textarea
      ...
      className={`w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none resize-y ${
        handlers.isEditable
          ? 'focus:border-blue-400 focus:ring-1 focus:ring-blue-400 bg-white'
